...
育苗期間終了後は育苗ハウスから苗を移動させ、メインのビニールハウスで育てられているため、そのビニールハウスの空気中の温湿度を取得するために引き続きビニールハウスに配置させていただいております。

# 育苗期間終了後の温湿度測定に関して

育苗期間終了後も引き続き温湿度測定をさせていただいております。
温度と湿度から導くことができる露点温度と飽差も同時に取得できるようにしております。

「飽差」とは、空気が含むことができる水蒸気の最大量（飽和水蒸気量）と、実際の水蒸気量との差を指します。これは、1立方メートルの空気中に追加で含むことができる水蒸気の量を示し、温度が高いほど飽差は大きくなります。飽差が高い状態では空気は乾燥しており、植物は水分蒸散を防ぐため気孔を閉じ、成長が制限されます。逆に飽差が低い場合、空気がほぼ飽和状態にあり、気孔が開いていても蒸散が起こらず、栄養吸収が妨げられます。適切な飽差の管理により、植物は水分と養分を効率的に吸収し、健康的に成長します。特にビニールハウスでの栽培において、この指標を適切にコントロールすることが重要です。

![](../images/prototype/prototype5/soracom/soracom_3.jpg#center)
