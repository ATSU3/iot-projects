...
### 2ndスパイラル(7月)
2ndスパイラルでは、確認のために現場に直接行く頻度を削減するため、遠隔地から農場の環境データをリアルタイムで取得できるようにしたいと思います。また、國本さんの自宅から農場までは10km以上の距離があるため、農場の環境データをリアルタイムで取得することができれば、温度の確認のためだけに現場に向かうまでの時間を大幅に短縮することができます。
